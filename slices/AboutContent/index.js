  ...
  <section>
    <div className="flex justify-center">
      <div className="flex flex-col">
        <span className="text-xl text-center px-4 py-8 md:py-10 md:px-6 lg:py-12">
        ...
        <div className="text-xl px-4 py-8 md:py-10 md:px-6 lg:py-12">
          <figure className="grid grid-cols-1 gap-4 text-center">
            ...
            />
            <figcaption>{slice.primary.imgdesc}</figcaption>
          </figure>
          ...
          <div className="px-4 py-8 md:py-10 md:px-6 lg:py-12">
            <div className="text-2xl mx-auto w-full max-w-3xl">
